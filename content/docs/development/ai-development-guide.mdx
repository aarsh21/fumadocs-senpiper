...
description: "This document outlines the documentation-first approach for enabling AI-driven development of the V2 runtime engine with minimal human developers."
---
