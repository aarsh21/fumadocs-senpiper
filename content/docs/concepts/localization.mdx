...
- **[Field Types](field-types)** - Fields that support localization
- **[Visibility & Access](visibility-access)** - Access control per language
- **[Form Structure](form-structure)** - Where localization fits
