---
title: "Property Cascading in V1"
description: "This document describes how field properties cascade from parent containers (sections, repeaters) to their children."
---
...
- [Visibility & Access Control](/docs/visibility-access) - Source of "gate" principle
- [Conditional Visibility](/docs/recipes/conditional-visibility) - Section show/hide examples
- [Section Field Type](/docs/reference/field-types/section) - Section behaviors
