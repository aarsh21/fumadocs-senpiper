...
description: "What Are Predicates?"
---
...
3. **Online Master** - Real-time API fetch. See [Master Data - Online](master-data.md#online-master) and [Master Data API Spec](../api/master-data-api)
...
1. **Field Level** - On individual [schema properties](schema-properties)
...
- **[Schema Properties](schema-properties)** - Field definitions and access matrix details
- **[Master Data](master-data)** - How OPTION_FILTER works with external data
- **[Visibility & Access](visibility-access)** - Deep dive into access control
- **[Recipes: Cascading Dropdowns](/docs/recipes/cascading-dropdown)** - Practical example
