...
description: "Before we dive into specific features like predicates or master data, we need to understand the fundamental structure that everything else builds upon."
---
